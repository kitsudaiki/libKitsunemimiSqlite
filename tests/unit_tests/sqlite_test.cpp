...
Sqlite_Test::execSqlCommand_test()
{
    ...
    std::string compare = "+----+-------+-----+------------+--------------+\n"
                          ...
                          "+====+=======+=====+============+==============+\n"
                          "| 1  | Paul  | 32  | California | 20000.000000 |\n"
                          "+----+-------+-----+------------+--------------+\n"
                          "| 2  | Allen | 25  | Texas      | 15000.000000 |\n"
                          "+----+-------+-----+------------+--------------+\n"
                          "| 3  | Teddy | 23  | Norway     | 20000.000000 |\n"
                          "+----+-------+-----+------------+--------------+\n"
                          "| 4  | Mark  | 25  | Rich-Mond  | 65000.000000 |\n"
                          "+----+-------+-----+------------+--------------+\n";
    ...
    compare = "+----+-------+-----+------------+--------------+\n"
              "| ID | NAME  | AGE | ADDRESS    | SALARY       |\n"
              "+====+=======+=====+============+==============+\n"
              "| 1  | Paul  | 32  | California | 25000.000000 |\n"
              "+----+-------+-----+------------+--------------+\n"
              "| 2  | Allen | 25  | Texas      | 15000.000000 |\n"
              "+----+-------+-----+------------+--------------+\n"
              "| 3  | Teddy | 23  | Norway     | 20000.000000 |\n"
